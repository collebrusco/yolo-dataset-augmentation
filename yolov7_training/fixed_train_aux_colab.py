...
if True:
    ...
    parser.add_argument('--data', type=str, default='../base.yaml', help='data.yaml path', required=False)
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.p5.yaml', help='hyperparameters path', required=False)
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[512, 512], help='[train, test] image sizes', required=False)
